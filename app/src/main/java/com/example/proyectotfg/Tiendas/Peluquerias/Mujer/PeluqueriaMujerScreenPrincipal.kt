package com.example.proyectotfg.Tiendas.Peluquerias.Mujer
...
@Composable
fun PeluqueriaMujerScreenPrincipal(navController: NavHostController) {
    Scaffold(
