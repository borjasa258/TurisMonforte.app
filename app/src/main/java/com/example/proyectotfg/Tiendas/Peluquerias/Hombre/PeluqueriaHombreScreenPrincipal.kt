package com.example.proyectotfg.Tiendas.Peluquerias.Hombre
...
@Composable
fun PeluqueriaHombreScreenPrincipal(navController: NavHostController) {
    Scaffold(
                ...
                Column(
                    ...
                    Column(
                        ...
                        LazyColumn(modifier = Modifier.weight(1f)) {
                            items(peluquerias) { peluqueria ->
                                PeluqueriaItem(peluqueria)
                            }
                        }
                    }
                }
