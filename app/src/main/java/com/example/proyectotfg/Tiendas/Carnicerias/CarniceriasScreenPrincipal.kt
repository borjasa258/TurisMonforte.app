...
import com.example.proyectotfg.Tiendas.Comercios.TiendaItem
...
@Composable
fun CarniceriasScreenPrincipal(navController: NavHostController) {
   Scaffold(
               ...
               Column(
                   ...
                   Column(
                       ...
                       LazyColumn(modifier = Modifier.weight(1f)) {
                           items(carnicerias) { carniceria ->
                               CarniceriasItem(carniceria)
                           }
                       }
                   }
               }
