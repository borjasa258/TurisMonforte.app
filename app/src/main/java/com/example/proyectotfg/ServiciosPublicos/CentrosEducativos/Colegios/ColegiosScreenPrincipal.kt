package com.example.proyectotfg.ServiciosPublicos.CentrosEducativos.Colegios
...
@Composable
fun ColegiosScreenPrincipal(navController: NavHostController) {
    Scaffold(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            Text(
                                text = "Colegios en Monforte del Cid",
