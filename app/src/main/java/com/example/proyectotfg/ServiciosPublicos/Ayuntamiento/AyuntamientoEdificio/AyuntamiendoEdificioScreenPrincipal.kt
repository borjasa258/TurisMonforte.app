package com.example.proyectotfg.ServiciosPublicos.Ayuntamiento.AyuntamientoEdificio
...
import com.example.proyectotfg.Tiendas.Peluquerias.PeluqueriaItem
...
@Composable
fun AyuntamientoEdificioScreenPrincipal(navController: NavHostController) {
    var expanded by remember { mutableStateOf(false) }
    val ayuntamiento = listOf(
       Ayuntamiento(
           "Ayuntamiento de Monforte del Cid",
           "Pl. de España, 1, 03670 Monforte del Cid, Alicante",
           "lunes - viernes: 9:00-13:00",
           "965620025",
           "Monforte del Cid",
           38.379550215742526, -0.7292278643769028,
           "https://maps.app.goo.gl/DnSFeXiGXQdCsq7R8"
       )
    )
