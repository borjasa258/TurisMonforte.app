package com.example.proyectotfg.ServiciosPublicos.CentrosEducativos.Institutos
...
import com.example.proyectotfg.ServiciosPublicos.CentrosEducativos.CentrosEducativosItem
import com.example.proyectotfg.TopBarMonforte.TopBarMonforte

@OptIn(ExperimentalMaterial3Api::class)
@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun InstitutosScreenPrincipal(navController: NavHostController) {
    Scaffold(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            Text(
                                text = "Institutos en Monforte del Cid",
                        ...
                        LazyColumn(modifier = Modifier.weight(1f)) {
                            items(centrosEducativos) { centrosEducativo ->
                                CentrosEducativosItem(centrosEducativo)
                            }
                        }
                    }
                }
