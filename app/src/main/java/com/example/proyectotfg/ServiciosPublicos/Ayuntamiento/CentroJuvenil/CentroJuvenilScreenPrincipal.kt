package com.example.proyectotfg.ServiciosPublicos.Ayuntamiento.CentroJuvenil
...
@Composable
fun CentroJuvenilScreenPrincipal(navController: NavHostController) {
    var expanded by remember { mutableStateOf(false) }
    val ayuntamiento = listOf(
        Ayuntamiento(
            "Casa de la Juventud",
            "Av. Miguel Candela Alberola, 03670 Monforte del Cid, Alicante",
            "lunes - viernes: 8:16-23:12;\n sábado - domingo: 9:00-23:12",
            "No Disponible",
            "Monforte del Cid",
            38.383112453299546, -0.7286609870071222,
            "https://maps.app.goo.gl/kyDaSz5nE8hPshrw6"
        )
    )
