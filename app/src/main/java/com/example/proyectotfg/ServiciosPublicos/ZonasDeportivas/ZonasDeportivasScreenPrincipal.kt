...
@Composable
fun ZonasDeportivasScreenPrincipal(navController: NavHostController) {
    Scaffold(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            Text(
                                text = "Zonas deportivas en Monforte del Cid",
                        ...
                        LazyColumn(modifier = Modifier.weight(1f)) {
                            items(zonasDeportivas) { zonasDeportiva ->
                                ZonasDeportivasItem(zonasDeportiva)
                            }
                        }
                    }
                }
