package com.example.proyectotfg.FiestasYTradiciones.FiestasSanRamon
...
@Composable
fun FiestasSanRamon(navController: NavHostController){
    Scaffold (
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.fiestasSanRamon1),
                            fontSize = 16.sp,
                            style = MaterialTheme.typography.bodyMedium
                        )
                        Spacer(modifier = Modifier.height(16.dp))
                        Image(
                            painter = painterResource(id = R.drawable.sanramon),
                            contentDescription = "Foto de San Ramón",
                            modifier = Modifier
                                .fillMaxWidth()
                                .height(300.dp)
                        )
